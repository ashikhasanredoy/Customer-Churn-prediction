...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        try:
            ...
            logging.info(f"all numerical columns:{num_columns}")
            logging.info(f"all categorical columns:{cat_columns}")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Taking preprocessor object")
            
            preprocessor_obj=self.get_data_transformer_obj()
            target_columns='Churn'
            
            imput_features_train_df=train_df.drop(columns=[target_columns])
            target_feature_train_df=train_df[target_columns]
            
            input_features_test_df=test_df.drop(columns=[target_columns])
